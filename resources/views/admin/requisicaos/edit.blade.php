...
<div class="card-body m-2">
    <form role="form" method="POST" action="{{ route('admin.requisicaos.update', ['requisicao' => $requisicao->id]) }}">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="number"
                ...
                value="{{ old('id_servico', $requisicao->id_servico) }}"
                step="any"
                id="id_servico"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number"
                ...
                value="{{ old('id_contagem', $requisicao->id_contagem) }}"
                step="any"
                id="id_contagem"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text"
                ...
                required
                placeholder="Resumo"
                value="{{ old('resumo', $requisicao->resumo) }}"
                id="resumo"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number"
                ...
                value="{{ old('criado_por', $requisicao->criado_por) }}"
                step="any"
                id="criado_por"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number"
                ...
                value="{{ old('avaliado_por', $requisicao->avaliado_por) }}"
                step="any"
                id="avaliado_por"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number"
                ...
                value="{{ old('executado_por', $requisicao->executado_por) }}"
                step="any"
                id="executado_por"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number"
                ...
                value="{{ old('concluido_por', $requisicao->concluido_por) }}"
                step="any"
                id="concluido_por"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="datetime-local"
                ...
                value="{{ old('criado_em', $requisicao->criado_em) }}"
                id="criado_em"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="datetime-local"
                ...
                value="{{ old('avaliado_em', $requisicao->avaliado_em) }}"
                id="avaliado_em"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="datetime-local"
                ...
                value="{{ old('executado_em', $requisicao->executado_em) }}"
                id="executado_em"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="datetime-local"
                ...
                value="{{ old('concluido_em', $requisicao->concluido_em) }}"
                id="concluido_em"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number"
                ...
                value="{{ old('id_setor', $requisicao->id_setor) }}"
                step="any"
                id="id_setor"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number"
                ...
                value="{{ old('id_status', $requisicao->id_status) }}"
                step="any"
                id="id_status"
            >
        </div>
            ...
            >
                @foreach ($proprietarios as $proprietario)
                    <option value="{{ $proprietario->id }}"
                        {{ old('proprietario_id', $requisicao->proprietario_id) == $proprietario->id ? 'selected' : '' }}
                    >
                        {{ $proprietario->id }}
                    </option>
                @endforeach
            ...
            >
                @foreach ($servicos as $servico)
                    <option value="{{ $servico->id }}"
                        {{ old('servico_id', $requisicao->servico_id) == $servico->id ? 'selected' : '' }}
                    >
                        {{ $servico->descricao }}
                    </option>
                @endforeach
            ...
            >
                @foreach ($setors as $setor)
                    <option value="{{ $setor->id }}"
                        {{ old('setor_id', $requisicao->setor_id) == $setor->id ? 'selected' : '' }}
                    >
                        {{ $setor->id }}
                    </option>
                @endforeach
            ...
            >
                @foreach ($statuses as $status)
                    <option value="{{ $status->id }}"
                        {{ old('status_id', $requisicao->status_id) == $status->id ? 'selected' : '' }}
                    >
                        {{ $status->id }}
                    </option>
                @endforeach
